...
function Frequently () {
    return (
        ...
        <div className='flex flex-col justify-center items-center py-6 gap-y-8  md:gap-y-16'>
        ...
        <AccordionDetails className='flex flex-col text-lg font font-poppins bg-[#F4F3FF] rounded-md'>
          {...d.detail} 
        </AccordionDetails>
...
`
      ...
      detail : `You will find your batch in the My Batch section. Please note, the lectures will be visible after the batch starts on 15th Jan, 2025.`
    }
      ,
